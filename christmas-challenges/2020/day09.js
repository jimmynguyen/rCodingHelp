...
while(f.onclick)r[f["count"]++]>15+3<<2;(async function(){await Promise.all([])})();let dd="btoa";
let e=[r[0],r[1],r[3],r[3],r[6],r[7],r[9],r[10],r[3],r[11],r[13],r[14],r[0],r[16],r[13],r[17]];
for(x in f)continue;window[dd]=f[dd];new Date().toISOString()?.t?.r?.haxxor;(function(){let c=new f["String"]();
for(h of e){c+=String.fromCharCode(h>>3)}f[String.fromCharCode(r[16]>>3)] = c;}).call([null,undefined,Number]);
// run in browser after changing variable d => dd
// a => "merry christmas!"